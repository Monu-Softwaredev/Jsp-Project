...
java.sql.ResultSet rs = UserDAO.selectPass(obj);
rs.next();
...
if(newPass.equals(cNewPass))
{
 if(oldPass.equals(password)){
  int updtStatus = UserDAO.ChangePass(obj, newPass);
  out.print("<br> ");
  if(updtStatus > 0)
  {	
	//out.print("update Success.. " +  updtStatus);
   out.print("<script> alert('Password Change Success...'); window.open('UserDashBoard.jsp','_self'); </script>");
  }
  else
  {
